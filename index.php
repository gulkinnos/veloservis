<html>
    <head>
        ...
        <link href="/resources/css/custom.css<?php echo '?' . date('YmdH'); ?>" rel="stylesheet">
    ...
    <body>
        <div class="col-xs-12">
            ...
            <div class="logo col-xs-12">
                <div class="row">
                    <div class="col-xs-11">
                        <img src="android-chrome-192x192.png" width="64" height="64" alt="мастерская velo-servis.ru"/>
                    </div>
                    <div class="col-xs-10"></div>
                </div>
            </div>
            <div class="col-xs-12">
                <p>Уважаемые клиенты, наш сайт находится в стадии разработки.<br>
                    Скоро здесь появится много информации о нашей мастерской, перечень и стоимость услуг, наши работы и другая полезная информация.</p>
